...
ENABLE_FINGERPRINT_WINDOWS = False  # Set to True to allow fingerprint worker on Windows
ENABLE_GPS = True  # Set to False to disable GPS location retrieval
ENABLE_GPS_WINDOWS = False  # Set to True to allow GPS worker/speed gate on Windows
...
FINGERPRINT_PACKET_ERROR_REOPEN_THRESHOLD = 3
FINGERPRINT_SENSOR_REOPEN_DELAY_SEC = 1.0
...
ALERT_EVIDENCE_SNAPSHOT_CAMERA_ID = int(os.getenv("CAMERA_ID", "0"))
ALERT_EVIDENCE_SNAPSHOT_WIDTH = 640
ALERT_EVIDENCE_SNAPSHOT_HEIGHT = 480
ALERT_EVIDENCE_SNAPSHOT_READ_ATTEMPTS = 3
...
ENABLE_HAZARD_STATUS_LOGGING = True
